...
class ReplayBuffer:
    ...
    def sample(self, batch_size):
        ...
        # random sequence
        index = np.random.randint(self._next_idx, self._next_idx+len(self._storage)-batch_size)
        indices = np.arange(index, index + batch_size)
        indices = indices % len(self._storage)
